<%@ Page Title="" Language="C#" MasterPageFile="~/Header_Footer.Master" AutoEventWireup="true" CodeBehind="ThayDoiMatKhau.aspx.cs" Inherits="QLBH_TeemoSneaker.Page_Customer.ThayDoiMatKhau" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="NguoiDung_Header" runat="server">
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="DangXuat_Header" runat="server">
</asp:Content>
<asp:Content ID="ThayDoiMatKhau" ContentPlaceHolderID="Content" runat="server">
    <%--css nội dung trang--%>
    <style>
        h4 {
            text-align: center;
...
.toggle-password:hover {
    color: #ff5e57;
        ...
        .center-message {
            ...
            font-weight: bold; /* In đậm thông báo */
            padding: 10px 0; /* Khoảng cách trên và dưới thông báo */
            display: block; /* Làm cho label có thể chiếm toàn bộ chiều rộng */
    ...
    <div id="loginSuccessModal" class="modal">
        <div class="modal-content">
            ...
            <div class="message-text-container">
                ...
                <div class="text">
                    <p class="message-text">Thay đổi thành công</p>
                    <p class="sub-text">Trở về đăng nhập</p>
                </div>
        ...
        <div class="table-content">
            ...
            <div class="box-info">
                ...
                <div class="box-content">
                    <div class="title-content">
                        <div class="input-group">
                            <asp:TextBox ID="txtDoiMatKhau" runat="server" TextMode="Password" CssClass="input" />
                            <label class="user-label" for="txtDoiMatKhau">Nhập mật khẩu mới</label>
                        <span class="toggle-password" onclick="togglePassword(this)"><i class="bi bi-eye-fill"></i>
                        </div>
                    </div>
                    <div class="content-box">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDoiMatKhau" ErrorMessage="Mật khẩu không được bỏ trống!" CssClass="validator-error"></asp:RequiredFieldValidator>
                    </div>
                </div>
        ...
        <div class="two-button">
            <div class="item-button" style="justify-content: center">
                <div class="item-btn-add">
                    <asp:Button ID="butDoiMatKhau" runat="server" Text="Đổi mật khẩu" CssClass="btn" OnClick="butDoiMatKhau_Click"></asp:Button>
                </div>
            </div>

            <div class="item-button" style="justify-content: center">
                <div class="item-btn-add" style="margin-top: -15px;">
                    <asp:Button ID="butQuayLai" runat="server" Text="Quay lại" CssClass="btn" PostBackUrl="~/Page_Customer/DangNhap.aspx" CausesValidation="false"></asp:Button>
                </div>
            </div>
        </div>
