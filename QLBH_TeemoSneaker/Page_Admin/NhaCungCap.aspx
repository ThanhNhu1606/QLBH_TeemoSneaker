<%@ Page Title="" Language="C#" MasterPageFile="~/Header_Footer_Admin.Master" AutoEventWireup="true" CodeBehind="NhaCungCap.aspx.cs" Inherits="QLBH_TeemoSneaker.Page_Admin.NhaCungCap" %>
    ...
    <div class="main-content">
        <div class="header">
            <div class="page-title">
                <h1>Quản lý danh mục nhà cung cấp</h1>
        ...
        <i class="bi bi-search"></i>
                ...
                <div class="item-button" style="justify-content: center">
                  ...
                  <i class="bi bi-plus-circle-fill me-1"></i> Thêm mới
                    ...
                    <div class="item-btn-add">
                        <asp:LinkButton ID="btnChiTiet" runat="server" CssClass="custom-link-button" OnClick="butThemChiTiet_Click">
<i class="bi bi-plus-circle-fill me-1"></i> Chi tiết
                        </asp:LinkButton>
                    </div>
     ...
     <h4>DANH SÁCH NHÀ CUNG CẤP</h4>
        ...
        <div class="item-table">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="dsSanPham" runat="server" DataKeyNames="MaNCC" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            <%--mã --%>
                            <asp:BoundField DataField="MaNCC" HeaderText="Mã NCC" ReadOnly="True">
                            ...
                            <asp:TemplateField HeaderText="Tên NCC">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtTenNCC" runat="server"
                                        Text='<%# Bind("TenNCC") %>' CssClass="form-control" 
                            ...
                            <asp:TemplateField HeaderText="Địa chỉ">
                                <ItemTemplate>
                                    <asp:Label ID="lblDiaChi" runat="server"
                                        CssClass="wrap-text"
                                        Text='<%# Eval("DiaChiNCC") %>'
                                        ToolTip='<%# Eval("DiaChiNCC") %>'
                                        Style="text-align: justify; margin-right: 20px; margin-left: 10px;" />
                                </ItemTemplate>
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Số điện thoại">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSdtNCC" runat="server"
                                        Text='<%# Bind("SdtNCC") %>' CssClass="form-control" 
            ...
            <div id="popupForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; display: flex; justify-content: center; align-items: center;">
                <div class="table-content" style="background: #fff; padding: 30px; border-radius: 10px; width: 500px; position: relative;">
                    ...
                    <h4 style="margin-bottom: 30px;">THÊM NHÀ CUNG CẤP</h4>

                    <!-- Ten -->
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtTenNCCMoi" runat="server" CssClass="input" />
                                <label class="user-label" for="txtTenNCCMoi">Tên nhà cung cấp</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtDiaChiNCCMoi" runat="server" CssClass="input" TextMode="MultiLine" Rows="3" />
                                <label class="user-label" for="txtDiaChiNCCMoi">Địa chỉ</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtSdtNCCMoi" runat="server" CssClass="input"/>
                                <label class="user-label" for="txtSdtNCCMoi">Số điện thoại</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-button" style="justify-content: center; margin-top: 20px;">
                        ...
                        <%--POPUP THÊM MỚI CHI TIẾT--%>
            <div id="popupForm1" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; display: flex; justify-content: center; align-items: center;">
                <div class="table-content" style="background: #fff; padding: 30px; border-radius: 10px; width: 500px; position: relative;">
                    <!-- Dấu "x" để đóng popup (Biểu tượng từ Bootstrap Icons) -->
                    <i class="bi bi-x" id="closePopup1" style="position: absolute; top: 10px; right: 10px; font-size: 24px; cursor: pointer; color: #ff5e57;"></i>

                    <h4 style="margin-bottom: 30px;">THÊM CHI TIẾT NHÀ CUNG CẤP</h4>

                    <!-- Nhà cung cấp -->
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group" style="display: flex; align-items: center; gap: 40px; margin-bottom: 20px; margin-top: 20px">
                                <label for="ddlNCC" style="width: 90px;">Nhà cung cấp</label>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group" style="display: flex; align-items: center; gap: 40px; margin-bottom: 20px; margin-top: 20px">
                                <label for="ddlGiay" style="width: 90px;">Tên giày</label>
                                <asp:DropDownList ID="ddlGiay" runat="server"
                                    CssClass="input"
                                    DataSourceID="dsGiay"
                                    DataTextField="TenGiay"
                                    DataValueField="MaGiay"
                                    Style="flex: 1">
                                </asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtNgay" runat="server" CssClass="input"/>
                                <label class="user-label" for="txtNgay">Ngày sản xuất</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtGhiChu" runat="server" CssClass="input" TextMode="MultiLine" Rows="3"/>
                                <label class="user-label" for="txtGhiChu">Ghi chú</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-button" style="justify-content: center; margin-top: 20px;">
                        <div class="item-btn-add">
                            <asp:Button ID="btnThemChiTiet" runat="server" Text="Xác nhận" CssClass="btn btn-success" OnClick="btnThemChiTiet_Click" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <%--chi tiết--%>
         <div class="label-table" style="margin-top:30px;">
     <h4>DANH SÁCH CHI TIẾT NHÀ CUNG CẤP</h4>
 </div>
                <div class="item-table" >
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="dsChiTiet" runat="server" DataKeyNames="MaGiay,MaNCC" CssClass="GridViewStyle"
                        AutoGenerateColumns="False"
                        OnRowEditing="dsChiTiet_RowEditing"
                        OnRowUpdating="dsChiTiet_RowUpdating"
                        OnRowCancelingEdit="dsChiTiet_RowCancelingEdit"
                        OnRowDeleting="dsChiTiet_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Nhà cung cấp">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblMaNCC" runat="server"
                                        Text='<%# Eval("MaNCC") %>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Tên giày">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblGiay" runat="server"
                                        Text='<%# Eval("MaGiay") %>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Ngày sản xuất">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="txtNgaySX" runat="server"
                                        Text='<%# Eval("NgaySX") %>' />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtNgaySX" runat="server"
                                        Text='<%# Bind("NgaySX") %>' CssClass="form-control"
                            ...
                            <asp:TemplateField HeaderText="Ghi chú">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="txtGhiChu" runat="server"
                                        CssClass="wrap-text"
                                        Text='<%# Eval("GhiChu") %>'
                                        ToolTip='<%# Eval("GhiChu") %>'
                                        Style="text-align: justify; margin-right: 20px; margin-left: 10px;" />
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtGhiChu" runat="server"
                                        ...
                                        CssClass="form-control"
                                        TextMode="MultiLine" Rows="3"
                                        Style="text-align: justify; width:230px;" />
                                </EditItemTemplate>
                            </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="dsGiay" runat="server"
            ConnectionString="<%$ ConnectionStrings:conn %>"
            SelectCommand="SELECT MaGiay, TenGiay FROM tblGIAY"></asp:SqlDataSource>

        <asp:SqlDataSource ID="dsNCC" runat="server"
            ConnectionString="<%$ ConnectionStrings:conn %>"
            SelectCommand="SELECT MaNCC, TenNCC FROM tblNHACUNGCAP"></asp:SqlDataSource>

        <asp:SqlDataSource ID="SqlDataSourceLoaiGiay" runat="server"
            ConnectionString="<%$ ConnectionStrings:conn %>"
            SelectCommand="SELECT * FROM tblNHACUNGCAP"
            InsertCommand="INSERT INTO tblNHACUNGCAP (MaNCC, TenNCC, DiaChiNCC, SdtNCC) VALUES (@MaNCC, @TenNCC, @DiaChiNCC, @SdtNCC)"
            UpdateCommand="UPDATE tblNHACUNGCAP SET TenNCC = @TenNCC, DiaChiNCC = @DiaChiNCC, SdtNCC = @SdtNCC WHERE MaNCC = @MaNCC"
            DeleteCommand="DELETE FROM tblNHACUNGCAP WHERE MaNCC = @MaNCC"
            >
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="DiaChiNCC" Type="String" />
                <asp:Parameter Name="SdtNCC" Type="String" />
            </InsertParameters>
        ...
        <%--chi tiết--%>
        <asp:SqlDataSource ID="SqlDataSourceChiTiet" runat="server"
    ConnectionString="<%$ ConnectionStrings:conn %>"
    SelectCommand="SELECT MaGiay, MaNCC, GhiChu, 
    CONVERT(varchar, NgaySX, 103) AS NgaySX 
FROM tblCT_NHACUNGCAP"

    InsertCommand="INSERT INTO tblCT_NHACUNGCAP (MaGiay, MaNCC, NgaySX, GhiChu) VALUES (@MaGiay, @MaNCC, @NgaySX, @GhiChu)"
    UpdateCommand="UPDATE tblCT_NHACUNGCAP SET NgaySX = @NgaySX, GhiChu = @GhiChu WHERE MaGiay = @MaGiay AND MaNCC = @MaNCC"
    DeleteCommand="DELETE FROM tblCT_NHACUNGCAP WHERE MaGiay = @MaGiay AND MaNCC = @MaNCC">
    ...
    <script type="text/javascript">
        ...
        function resetTextBoxes() {
            document.getElementById("<%= txtTenNCCMoi.ClientID %>").value = "";  // Reset Tên loại giày
            document.getElementById("<%= txtDiaChiNCCMoi.ClientID %>").value = "";  // Reset Đặc điểm
            document.getElementById("<%= txtSdtNCCMoi.ClientID %>").value = "";  // Reset Đặc điểm
        }
    ...
    <script type="text/javascript">
        ...
        function resetTextBoxes1() {
        }

        function hidePopup1(event) {
            // Kiểm tra nếu người dùng nhấn vào phần nền ngoài form (popupForm1)
            if (event.target.id === "popupForm1") {
        ...
        function showPopup1() {
            ...
            var popup1 = document.getElementById('popupForm1');
        ...
        // Đóng popup khi click vào dấu "x"
        document.getElementById('closePopup1').addEventListener('click', hidePopup1);

        // Lắng nghe sự kiện click trên toàn bộ trang để ẩn popup khi nhấn bên ngoài form
        document.getElementById('popupForm1').addEventListener('click', function (event) {
            // Nếu người dùng nhấn vào phần nền ngoài form, ẩn popup
            if (event.target.id === "popupForm1") {
                hidePopup1(event);
            }
