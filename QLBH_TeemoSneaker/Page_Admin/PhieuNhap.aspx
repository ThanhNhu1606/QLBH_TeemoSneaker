<%@ Page Title="" Language="C#" MasterPageFile="~/Header_Footer_Admin.Master" AutoEventWireup="true" CodeBehind="PhieuNhap.aspx.cs" Inherits="QLBH_TeemoSneaker.Page_Admin.PhieuNhap" %>
    ...
    <div class="main-content">
        <div class="header">
            <div class="page-title">
                <h1>Quản lý danh mục phiếu nhập</h1>
...
<i class="bi bi-file-earmark-spreadsheet-fill"></i> Xuất Excel
        ...
        <div class="table-view">
            <div class="item-table">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="dsSanPham" runat="server" DataKeyNames="MaPN" CssClass="GridViewStyle"
                            ...
                            <Columns>
                                <%--mã --%>
                                <asp:BoundField DataField="MaPN" HeaderText="Mã PN" ReadOnly="True">
                                    <ItemStyle Width="100px" />
                                </asp:BoundField>

                                <%--tên--%>
                                <asp:TemplateField HeaderText="Mã giày">
                                ...
                                <asp:TemplateField HeaderText="Số lượng">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSL" runat="server"
                                            Text='<%# Bind("SLPN") %>' CssClass="form-control"
                                ...
                                <asp:TemplateField HeaderText="Tổng">
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTong" runat="server"
                                            Text='<%# Eval("TongTienPN","{0:0,000}") %>' 
                                            Style="text-align: center;" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtTong" runat="server"
                                            Text='<%# Bind("TongTienPN") %>'
                                            CssClass="form-control"
                                            Style="text-align: center; width: 130px;" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                ...
                                <%--người lập--%>
                                <asp:TemplateField HeaderText="Người lập">
                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                ...
                <div id="popupForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; display: flex; justify-content: center; align-items: center;">
                    <div class="table-content" style="background: #fff; padding: 30px; border-radius: 10px; width: 500px; position: relative;">
                        ...
                        <h4 style="margin-bottom: 30px;">THÊM PHIẾU NHẬP</h4>
                        ...
                        <div class="box-info">
                            ...
                            <div class="box-content">
                                <div class="title-content">
                                    <div class="input-group">
                                        ...
                                        <label class="user-label" for="txtGia">Giá nhập</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-content">
                                <div class="title-content">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtSL" runat="server" CssClass="input" />
                                        <label class="user-label" for="txtSL">Số lượng</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-info">
                            ...
                            <div class="box-content">
                                <div class="title-content">
                                    <div class="input-group">
                                        ...
                                        <label class="user-label" for="txtNgay">Ngày nhập (yyyy-MM-dd)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-content">
                                <div class="title-content">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtGio" runat="server" CssClass="input time-input" TextMode="Time"/>
                                        <label class="user-label" for="txtGio">Giờ nhập (HH:mm:ss)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-content">
                            <div class="title-content">
                                <div class="input-group">
                                    <asp:TextBox ID="txtLuuY" runat="server" CssClass="input" TextMode="MultiLine" Rows="3" />
                                    <label class="user-label" for="txtLuuY">Ghi chú</label>
                                </div>
                            </div>
                        </div>
        ...
        <asp:SqlDataSource ID="dsNhanVien" runat="server"
            ConnectionString="<%$ ConnectionStrings:conn %>"
            SelectCommand="SELECT MaNV, TenNV FROM tblNHANVIEN"></asp:SqlDataSource>

        <asp:SqlDataSource ID="SqlDataSourceLoaiGiay" runat="server"
            ConnectionString="<%$ ConnectionStrings:conn %>"
            SelectCommand="SELECT * FROM tblPHIEUNHAP"
            UpdateCommand="UPDATE tblPHIEUNHAP SET MaGiay = @MaGiay, GiaPN = @GiaPN, SLPN = @SLPN, TongTienPN = @TongTienPN, MaNV = @MaNV WHERE MaPN = @MaPN"
            DeleteCommand="DELETE FROM tblCT_PHIEUNHAP WHERE MaPN = @MaPN;
               DELETE FROM tblPHIEUNHAP WHERE MaPN = @MaPN">
            <%--tham số cập nhập--%>
            <UpdateParameters>
                <asp:Parameter Name="MaPN" Type="String" />
                <asp:Parameter Name="MaGiay" Type="String" />
                <asp:Parameter Name="GiaPN" Type="String" />
                <asp:Parameter Name="SLPN" Type="String" />
                <asp:Parameter Name="TongTienPN" Type="String" />
    ...
    <script type="text/javascript">
        ...
        function resetTextBoxes() {
            document.getElementById("<%= txtGia.ClientID %>").value = "";  // Reset Tên loại giày
            document.getElementById("<%= txtGio.ClientID %>").value = "";  // Reset Đặc điểm
            document.getElementById("<%= txtLuuY.ClientID %>").value = "";  // Reset Đặc điểm
            document.getElementById("<%= txtNgay.ClientID %>").value = "";  // Reset Tên loại giày
            document.getElementById("<%= txtSL.ClientID %>").value = "";  // Reset Đặc điểm
            document.getElementById("<%= ddlGiay.ClientID %>").value = "";  // Reset Đặc điểm
        }
