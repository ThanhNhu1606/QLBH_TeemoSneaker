<%@ Page Title="" Language="C#" MasterPageFile="~/Header_Footer_Admin.Master" AutoEventWireup="true" CodeBehind="KhachHang.aspx.cs" Inherits="QLBH_TeemoSneaker.Page_Admin.KhachHang" %>
        ...
        <div class="table-view">
            ...
            <div class="item-table">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="dsSanPham" runat="server" DataKeyNames="MaKH" CssClass="GridViewStyle"
                                ...
                                <asp:TemplateField HeaderText="Giới tính">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblGioiTinh" runat="server"
                                            Text='<%# Eval("GioiTinhKH") == "true" ? "Nam" : "Nữ" %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSourceLoaiGiay" runat="server"
                    ...
                    SelectCommand="SELECT MaKH, HoKH, TenKH, SdtKH, DiaChiKH, EmailKH, 
    CASE 
        WHEN GioiTinhKH = 1 THEN N'Nam'
        ELSE N'Nữ'
    END AS GioiTinhKH,
    CONVERT(varchar, NgaySinhKH, 103) AS NgaySinhKH 
FROM tblKHACHHANG"></asp:SqlDataSource>
