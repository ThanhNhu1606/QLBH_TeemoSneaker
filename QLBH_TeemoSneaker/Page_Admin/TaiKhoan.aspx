<%@ Page Title="" Language="C#" MasterPageFile="~/Header_Footer_Admin.Master" AutoEventWireup="true" CodeBehind="TaiKhoan.aspx.cs" Inherits="QLBH_TeemoSneaker.Page_Admin.TaiKhoan" %>
    ...
    <div class="table-view">
        ...
        <div class="item-table">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="dsSanPham" runat="server" DataKeyNames="MaChucVu" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            <%--mã loại giày--%>
                            <asp:BoundField DataField="MaChucVu" HeaderText="Mã chức vụ" ReadOnly="True">
                            ...
                            <asp:TemplateField HeaderText="Tên chức vụ">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtTenLoaiGiay" runat="server"
                                        Text='<%# Bind("TenChucVu") %>' CssClass="form-control" 
                                         TextMode="MultiLine" Rows="2"
                                        Style="text-align: justify; width:280px;"/>
                                </EditItemTemplate>
                            </asp:TemplateField>
 ...
 <asp:TemplateField HeaderText="Hành động">
     ...
     <ItemTemplate>
         <asp:Button ID="btnXoa" runat="server" Text="Xóa"
            ...
            <div id="popupForm" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; display: flex; justify-content: center; align-items: center;">
                <div class="table-content" style="background: #fff; padding: 30px; border-radius: 10px; width: 500px; position: relative;">
                    ...
                    <h4 style="margin-bottom: 30px;">THÊM TÀI KHOẢN</h4>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                ...
                                <label class="user-label" for="txtTenLoaiGiayMoi">Tên chức vụ</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-content">
                        <div class="title-content">
                            <div class="input-group">
                                <asp:TextBox ID="txtDacDiemMoi" runat="server" CssClass="input"/>
                                <label class="user-label" for="txtDacDiemMoi">Mật khẩu</label>
                            </div>
                        </div>
                    </div>
        ...
        <asp:SqlDataSource ID="SqlDataSourceLoaiGiay" runat="server"
            ...
            SelectCommand="SELECT * FROM tblCHUCVUNV"
            InsertCommand="INSERT INTO tblCHUCVUNV (MaChucVu, TenChucVu, MatKhau) VALUES (@MaChucVu, @TenChucVu, @MatKhau)"
            UpdateCommand="UPDATE tblCHUCVUNV SET TenChucVu = @TenChucVu, MatKhau = @MatKhau WHERE MaChucVu = @MaChucVu"
            DeleteCommand="DELETE FROM tblCHUCVUNV WHERE MaChucVu = @MaChucVu">

            <%--tham số thêm--%>
            <InsertParameters>
                <asp:Parameter Name="MaChucVu" Type="String" />
                <asp:Parameter Name="TenChucVu" Type="String" />
